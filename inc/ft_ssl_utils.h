...
/*   Updated: 2019/09/17 12:26:14 by pheilbro         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		u64_le_to_u8(uint64_t *in, uint8_t **out, uint8_t len);
void		u8_to_u32_be(uint8_t *in, uint32_t **out, int len);
void		u8_to_u32_le(uint8_t *in, uint32_t **out, int len);
void		u8_to_u64_be(uint8_t *in, uint64_t **out, int len);
void		u8_to_u64_le(uint8_t *in, uint64_t **out, int len);
